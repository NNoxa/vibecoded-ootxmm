...
void func_80850BF8(Player* this, f32 arg1) {
    ...
    turnStickX = (this->currentBoots >= PLAYER_BOOTS_ZORA_UNDERWATER) ? (this->unk_B8A / 0x64) : stickX;

    Math_AsymStepToF(&this->unk_B48, arg1, 1.0f, (fabsf(this->unk_B48) * 0.01f) + 0.4f);
    temp_fv0 = Math_CosS(turnStickX * 0x10E);

    temp_ft0 = (((turnStickX >= 0) ? 1 : -1) * (1.0f - temp_fv0) * -1100.0f);
