...
void BenMenu::AddEnhancements() {
    ...
    CVarSetInteger("gEnhancements.Saving.FileSlot3", 1);
    AddWidget(path, "3rd Save File Slot", WIDGET_CVAR_CHECKBOX)
        .CVar("gEnhancements.Saving.FileSlot3")
        .Options(CheckboxOptions({ { .tooltip = "Adds a 3rd file slot that can be used for saves",
                                     .disabled = true,
                                     .disabledTooltip = "Always enabled in OoTxMM crossover." } })
                     .DefaultValue(true));
