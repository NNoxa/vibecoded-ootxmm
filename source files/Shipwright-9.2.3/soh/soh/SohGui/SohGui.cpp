...
void ShowComboRandomizerSettingsMenu() {
    CVarSetString(CVAR_SETTING("Menu.ActiveHeader"), "Combo Randomizer");
    CVarSetString(CVAR_SETTING("Menu.ComboRandomizerSidebarSection"), "General");
    mSohMenu->Show();
}
