...
void Settings::CreateOptions() {
    ...
    for (const auto disabledOoTxMmTriforceSetting : { RSK_TRIFORCE_HUNT, RSK_TRIFORCE_HUNT_PIECES_TOTAL,
                                                      RSK_TRIFORCE_HUNT_PIECES_REQUIRED }) {
        mOptions[disabledOoTxMmTriforceSetting].SetContextIndex(RO_TRIFORCE_HUNT_OFF);
        CVarSetInteger(mOptions[disabledOoTxMmTriforceSetting].GetCVarName().c_str(), RO_TRIFORCE_HUNT_OFF);
        mOptions[disabledOoTxMmTriforceSetting].Disable("Disabled in OoTxMM crossover seeds.");
    }
    mOptions[RSK_TRIFORCE_HUNT_PIECES_REQUIRED].Hide();
    mOptions[RSK_TRIFORCE_HUNT_PIECES_TOTAL].Hide();
    ...
    for (const auto disabledOoTxMmSetting :
         { RSK_SHUFFLE_CHILD_WALLET, RSK_SHUFFLE_SWIM, RSK_SHUFFLE_GRAB, RSK_SHUFFLE_CLIMB, RSK_SHUFFLE_CRAWL,
           RSK_SHUFFLE_SPEAK, RSK_SHUFFLE_OPEN_CHEST }) {
        mOptions[disabledOoTxMmSetting].SetContextIndex(RO_GENERIC_OFF);
        CVarSetInteger(mOptions[disabledOoTxMmSetting].GetCVarName().c_str(), RO_GENERIC_OFF);
        mOptions[disabledOoTxMmSetting].Disable("Disabled in OoTxMM crossover seeds.");
    }
    ...
    for (const auto disabledOoTxMmSetting : { RSK_SHUFFLE_TREES, RSK_SHUFFLE_BUSHES }) {
        mOptions[disabledOoTxMmSetting].SetContextIndex(RO_GENERIC_OFF);
        CVarSetInteger(mOptions[disabledOoTxMmSetting].GetCVarName().c_str(), RO_GENERIC_OFF);
        mOptions[disabledOoTxMmSetting].Disable("Disabled in OoTxMM crossover seeds.");
    }
    ...
    mOptions[RSK_SHUFFLE_BEAN_SOULS].SetContextIndex(RO_GENERIC_OFF);
    CVarSetInteger(mOptions[RSK_SHUFFLE_BEAN_SOULS].GetCVarName().c_str(), RO_GENERIC_OFF);
    mOptions[RSK_SHUFFLE_BEAN_SOULS].Disable("Disabled in OoTxMM crossover seeds.");
    ...
    for (const auto disabledOoTxMmSetting : { RSK_SHUFFLE_DEKU_STICK_BAG, RSK_SHUFFLE_DEKU_NUT_BAG }) {
        mOptions[disabledOoTxMmSetting].SetContextIndex(RO_GENERIC_OFF);
        CVarSetInteger(mOptions[disabledOoTxMmSetting].GetCVarName().c_str(), RO_GENERIC_OFF);
        mOptions[disabledOoTxMmSetting].Disable("Disabled in OoTxMM crossover seeds.");
    }
    ...
    mOptions[RSK_SHUFFLE_BEAN_FAIRIES].SetContextIndex(RO_GENERIC_OFF);
    CVarSetInteger(mOptions[RSK_SHUFFLE_BEAN_FAIRIES].GetCVarName().c_str(), RO_GENERIC_OFF);
    mOptions[RSK_SHUFFLE_BEAN_FAIRIES].Disable("Disabled in OoTxMM crossover seeds.");
