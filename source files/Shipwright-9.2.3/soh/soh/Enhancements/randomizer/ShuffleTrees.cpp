...
extern "C" void EnWood02_RandomizerDraw(Actor* thisx, PlayState* play) {
    ...
    if (isVanilla) {
        ...
        getItemCategory = Randomizer_AdjustItemCategoryForCheck(treeItem, treeIdentity->randomizerCheck);
    }
...
void EnWood02_RandomizerSpawnCollectible(EnWood02* treeActor, PlayState* play) {
    ...
    item00->randoCheck = treeIdentity->randomizerCheck;
    item00->randoInf = treeIdentity->randomizerInf;
    item00->itemEntry = Randomizer_ApplyCrossoverVisualOnlyItemEntry(
