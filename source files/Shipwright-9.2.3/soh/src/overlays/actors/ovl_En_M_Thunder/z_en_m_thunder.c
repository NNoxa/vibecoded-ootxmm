...
static void EnMThunder_SwordBeamAction(EnMThunder* this, PlayState* play) {
    ...
    velocity = -80.0f * Math_CosS(this->actor.world.rot.x);
    this->actor.world.pos.x += velocity * Math_SinS(this->actor.shape.rot.y);
    this->actor.world.pos.z += velocity * Math_CosS(this->actor.shape.rot.y);
    ...
    if (this->collider.base.atFlags & AT_HIT) {
        ...
        if (hitActor != NULL) {
            ...
            EffectSsBlast_SpawnWhiteCustomScale(play, &hitActor->focus.pos, &velocity, &accel, 100, 250, 8);
        }
        Actor_Kill(&this->actor);
        return;
    }
...
void EnMThunder_Update(Actor* thisx, PlayState* play) {
    ...
    if (this->unk_1C6 == 2) {
        Lights_PointNoGlowSetInfo(&this->lightInfo, this->actor.world.pos.x, this->actor.world.pos.y,
                                  this->actor.world.pos.z, (s32)(this->unk_1AC * 255.0f),
                                  (s32)(this->unk_1AC * 255.0f), (s32)(this->unk_1AC * 100.0f),
                                  (s32)(this->unk_1AC * 800.0f));
        return;
    }
...
void EnMThunder_Draw(Actor* thisx, PlayState* play2) {
    ...
    if (this->unk_1C6 == 2) {
        u16 alpha = (u16)(this->unk_1B0 * 255.0f);
        Gfx* beamDL = OoTxMm_GetFierceDeitySwordBeamDisplayList(play);
        ...
        if (beamDL != NULL) {
            ...
            gSPSegment(POLY_XLU_DISP++, 0x08,
                       Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, 0xFF - ((u8)(s32)(this->unk_1B4 * 30) & 0xFF), 0,
                                          0x40, 0x20, 1, 0xFF - ((u8)(s32)(this->unk_1B4 * 20) & 0xFF), 0, 8, 8, -30,
                                          0, -20, 0));
